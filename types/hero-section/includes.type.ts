...
export interface IHeroSectionIncludes {
    isPackageServiceCreatorOpen: boolean;
    setIsPackageServiceCreatorOpen: Dispatch<SetStateAction<boolean>>
    handleCustomPackageOrder: (services: any[], totalPrice: number) => void;
    isAnimate: boolean;
